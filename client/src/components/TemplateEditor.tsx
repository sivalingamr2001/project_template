      ...
      <CardContent className="space-y-6 p-6">
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-6 rounded-3xl border border-border bg-background/80 p-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={handleAddSubcategory} size="sm" className="shrink-0">
            ...
            {pendingItems.length > 0 && (
              <div className="rounded-2xl border border-border p-4 bg-muted/20">
                <p className="text-sm font-semibold text-foreground">Current subcategories</p>
                <ul className="mt-3 space-y-2 text-sm text-muted-foreground">
                  {pendingItems.map((item) => (
                    <li key={item} className="rounded-xl bg-slate-950/80 px-3 py-2">
                      {item}
                    </li>
                  ))}
                </ul>
          ...
          <div className="space-y-4 rounded-3xl border border-border bg-background/80 p-6">
                    ...
                    >
                      ...
                      <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                        {category.items.map((item) => (
                          <li key={item} className="flex items-center gap-2 rounded-2xl border border-border/60 bg-muted/10 px-3 py-2">
            ...
            <div>
              <p className="mb-2 text-sm font-semibold text-foreground">JSON Preview</p>
