...
const lightTheme = themeQuartz.withParams({
  ...
  headerBackgroundColor: "oklch(0.985 0 0)",
  headerTextColor: "oklch(0.141 0.005 285.823)",
  backgroundColor: "oklch(1 0 0)",
  foregroundColor: "oklch(0.141 0.005 285.823)",
...
const darkTheme = themeQuartz.withParams({
  accentColor: "oklch(0.424 0.199 265.638)",
  headerBackgroundColor: "oklch(0.21 0.006 285.885)",
